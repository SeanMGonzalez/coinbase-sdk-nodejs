...
export class ExternalAddress extends Address {
   ...
   *  - `validator_pub_keys` (optional): List of validator public keys to unstake. Defaults to validators being picked up on your behalf corresponding to the unstake amount.
   *
